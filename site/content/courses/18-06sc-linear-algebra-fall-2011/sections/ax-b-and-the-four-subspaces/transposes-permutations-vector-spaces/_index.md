...
*   Watch the video lecture {{< youtube JibVXBElKL0 >}}
...
*   Watch the recitation video on {{< youtube QQpvGlF\_1Qo >}}
...
*   观看视频: 习题讲解 -- {{< youtube VyPIQ\_8QqEk >}}
...
*   [Problems (PDF)]({{% getpage "courses/18-06sc-linear-algebra-fall-2011/sections/ax-b-and-the-four-subspaces/transposes-permutations-vector-spaces/MIT18_06SCF11_Ses1.5prob" %}})
*   [Solutions (PDF)]({{% getpage "courses/18-06sc-linear-algebra-fall-2011/sections/ax-b-and-the-four-subspaces/transposes-permutations-vector-spaces/MIT18_06SCF11_Ses1.5sol" %}})
