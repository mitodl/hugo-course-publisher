...
*   Watch the video lecture {{< youtube lGGDIGizcQ0 >}}
...
*   Watch the recitation video on {{< youtube wuyAeWE3iIM >}}
...
*   [Problems (PDF)]({{% getpage "courses/18-06sc-linear-algebra-fall-2011/sections/least-squares-determinants-and-eigenvalues/markov-matrices-fourier-series/MIT18_06SCF11_Ses2.11prob" %}})
*   [Solutions (PDF)]({{% getpage "courses/18-06sc-linear-algebra-fall-2011/sections/least-squares-determinants-and-eigenvalues/markov-matrices-fourier-series/MIT18_06SCF11_Ses2.11sol" %}})
