...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-3-multiple-linear-regression
    weight: 450
---
*   [<Quick Question]({{< ref "quick-question-54" >}})
...
*   [\\>Quick Question]({{< ref "quick-question-73" >}})

Video 3: Multiple Linear Regression
-----------------------------------

*   [BackQuick Question]({{< ref "quick-question-54" >}})
*   [ContinueQuick Question]({{< ref "quick-question-73" >}})