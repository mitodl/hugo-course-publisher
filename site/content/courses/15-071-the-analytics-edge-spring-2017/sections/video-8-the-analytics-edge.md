...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-8-the-analytics-edge
    weight: 920
---
*   [<Quick Question]({{< ref "quick-question-208" >}})
...
*   [BackQuick Question]({{< ref "quick-question-208" >}})
*   [ContinueThe Framingham Heart Study: Evaluating Risk Factors to Save Lives]({{< ref "the-framingham-heart-study-evaluating-risk-factors-to-save-lives" >}})