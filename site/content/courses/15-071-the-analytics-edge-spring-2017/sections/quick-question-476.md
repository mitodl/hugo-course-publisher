...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: quick-question-476
    weight: 2090
---
*   [<Video 7: Hierarchical Clustering in R]({{% ref "video-7-hierarchical-clustering-in-r" %}})
...
*   [BackVideo 7: Hierarchical Clustering in R]({{% ref "video-7-hierarchical-clustering-in-r" %}})
*   [ContinueVideo 8: The Analytics Edge of Recommendation Systems]({{% ref "video-8-the-analytics-edge-of-recommendation-systems" %}})