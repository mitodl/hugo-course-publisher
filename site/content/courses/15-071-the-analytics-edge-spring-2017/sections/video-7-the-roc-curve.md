...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-7-the-roc-curve
    weight: 1890
---
*   [<Video 6: Evaluating the Model]({{% ref "video-6-evaluating-the-model" %}})
...
*   [BackVideo 6: Evaluating the Model]({{% ref "video-6-evaluating-the-model" %}})
*   [ContinueVideo 8: Predictive Coding Today]({{% ref "video-8-predictive-coding-today" %}})