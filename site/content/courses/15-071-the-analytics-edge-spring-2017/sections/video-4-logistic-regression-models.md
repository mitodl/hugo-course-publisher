...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-4-logistic-regression-models
    weight: 1080
---
...
*   [BackVideo 3: A Sophisticated Baseline Method]({{% ref "video-3-a-sophisticated-baseline-method" %}})
*   [ContinueVideo 5: Test Set Predictions]({{% ref "video-5-test-set-predictions" %}})