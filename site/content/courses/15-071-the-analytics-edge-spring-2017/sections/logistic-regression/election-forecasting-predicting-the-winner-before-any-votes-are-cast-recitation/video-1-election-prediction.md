...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: 1b20fb75340f27697ffe9d500a06dad9_video-1-election-prediction
    weight: 1050
    parent: >-
      cd55cbba60f6d5d37320e05f520c4cf1_election-forecasting-predicting-the-winner-before-any-votes-are-cast-recitation
---
*   [<Election Forecasting: Predicting the Winner Before any Votes are Cast (Recitation)]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/logistic-regression/election-forecasting-predicting-the-winner-before-any-votes-are-cast-recitation" %}})
...
*   [\\>Video 2: Dealing with Missing Data]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/logistic-regression/election-forecasting-predicting-the-winner-before-any-votes-are-cast-recitation/video-2-dealing-with-missing-data" %}})

Video 1: Election Prediction
----------------------------

The slides from all videos in this Recitation can be downloaded here: [Election Forecasting (PDF)](https://open-learning-course-data-ci.s3.amazonaws.com/15-071-the-analytics-edge-spring-2017/c5e5a08506e7cfeb409e08ac8eeaf9b8_MIT15_071S17_Unit3_Recitation.pdf).
...
*   [BackElection Forecasting: Predicting the Winner Before any Votes are Cast (Recitation)]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/logistic-regression/election-forecasting-predicting-the-winner-before-any-votes-are-cast-recitation" %}})
*   [ContinueVideo 2: Dealing with Missing Data]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/logistic-regression/election-forecasting-predicting-the-winner-before-any-votes-are-cast-recitation/video-2-dealing-with-missing-data" %}})