...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-5-hierarchical-clustering
    weight: 2040
---
*   [<Quick Question]({{% ref "quick-question-451" %}})
...
*   [\\>Quick Question]({{% ref "quick-question-458" %}})

Video 5: Hierarchical Clustering
--------------------------------

*   [BackQuick Question]({{% ref "quick-question-451" %}})
*   [ContinueQuick Question]({{% ref "quick-question-458" %}})