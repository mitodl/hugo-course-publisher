...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: ff7dc49d2cdefc1ac3e5d01f07046ac1_quick-question-297
    weight: 200
    parent: >-
      11f9b44dc2960689414b8c313764a18d_judge-jury-and-classifier-an-introduction-to-trees
---
*   [<Video 5: Random Forests]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/trees/judge-jury-and-classifier-an-introduction-to-trees/video-5-random-forests" %}})
...
*   [\\>Video 6: Cross-Validation]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/trees/judge-jury-and-classifier-an-introduction-to-trees/video-6-cross-validation" %}})
...
*   [BackVideo 5: Random Forests]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/trees/judge-jury-and-classifier-an-introduction-to-trees/video-5-random-forests" %}})
*   [ContinueVideo 6: Cross-Validation]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/trees/judge-jury-and-classifier-an-introduction-to-trees/video-6-cross-validation" %}})