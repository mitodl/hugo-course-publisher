...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: eaf609ccc68c36a2cb165b923543a1c7
    weight: 2920
    parent: 7a59278a134c5085244c381fc6090890
type: courses
layout: videogallery
---
*   [<Quick Question]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/linear-optimization/radiation-therapy-an-application-of-linear-optimization/quick-question-654" %}})
...
*   [\\>Google AdWords: Optimizing Online Advertising (Recitation)]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/linear-optimization/google-adwords-optimizing-online-advertising-recitation/_index.md" %}})

Video 6: The Analytics Edge
---------------------------

*   [BackQuick Question]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/linear-optimization/radiation-therapy-an-application-of-linear-optimization/quick-question-654" %}})
*   [ContinueGoogle AdWords: Optimizing Online Advertising (Recitation)]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/linear-optimization/google-adwords-optimizing-online-advertising-recitation/_index.md" %}})