...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: f7583f866400a48cea21c46483b728b2
    weight: 2670
...
*   [\\>Airline Revenue Management: An Introduction to Linear Optimization]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/linear-optimization/airline-revenue-management-an-introduction-to-linear-optimization/_index.md" %}})
...
*   [ContinueAirline Revenue Management: An Introduction to Linear Optimization]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/linear-optimization/airline-revenue-management-an-introduction-to-linear-optimization/_index.md" %}})