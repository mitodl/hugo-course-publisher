...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-4-creating-plots-in-r
    weight: 320
---
...
*   [\\>Video 5: Adding Variables]({{% ref "video-5-adding-variables" %}})

Video 4: Creating Plots in R
----------------------------

*   [BackVideo 3: Data Analysis]({{% ref "video-3-data-analysis" %}})
*   [ContinueVideo 5: Adding Variables]({{% ref "video-5-adding-variables" %}})