...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-4-error-measures
    weight: 1330
---
*   [<Quick Question]({{< ref "quick-question-321" >}})
...
*   [\\>Quick Question]({{< ref "quick-question-326" >}})

Video 4: Error Measures
-----------------------

*   [BackQuick Question]({{< ref "quick-question-321" >}})
*   [ContinueQuick Question]({{< ref "quick-question-326" >}})