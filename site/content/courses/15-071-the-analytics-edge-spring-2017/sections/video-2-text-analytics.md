...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-2-text-analytics
    weight: 1580
---
*   [<Turning Tweets into Knowledge: An Introduction to Text Analytics]({{% ref "turning-tweets-into-knowledge-an-introduction-to-text-analytics" %}})
...
*   [\\>Quick Question]({{% ref "quick-question-362" %}})

Video 2: Text Analytics
-----------------------

*   [BackTurning Tweets into Knowledge: An Introduction to Text Analytics]({{% ref "turning-tweets-into-knowledge-an-introduction-to-text-analytics" %}})
*   [ContinueQuick Question]({{% ref "quick-question-362" %}})