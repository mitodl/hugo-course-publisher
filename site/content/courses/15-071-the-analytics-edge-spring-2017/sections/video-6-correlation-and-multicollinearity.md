...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-6-correlation-and-multicollinearity
    weight: 510
---
*   [<Quick Question]({{% ref "quick-question-88" %}})
...
*   [\\>Quick Question]({{% ref "quick-question-96" %}})

Video 6: Correlation and Multicollinearity
------------------------------------------

*   [BackQuick Question]({{% ref "quick-question-88" %}})
*   [ContinueQuick Question]({{% ref "quick-question-96" %}})