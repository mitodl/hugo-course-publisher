...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: dc9db678f1283a5e3783460ede434049
    weight: 2330
...
*   [BackVisualizing the World: An Introduction to Visualization]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/visualization/visualizing-the-world-an-introduction-to-visualization/_index.md" %}})
*   [ContinueVideo 2: The World Health Organization (WHO)]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/visualization/visualizing-the-world-an-introduction-to-visualization/video-2-the-world-health-organization-who" %}})