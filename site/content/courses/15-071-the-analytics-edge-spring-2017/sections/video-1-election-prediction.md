...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-1-election-prediction
    weight: 1050
---
*   [<Election Forecasting: Predicting the Winner Before any Votes are Cast (Recitation)]({{% ref "election-forecasting-predicting-the-winner-before-any-votes-are-cast-recitation" %}})
...
*   [BackElection Forecasting: Predicting the Winner Before any Votes are Cast (Recitation)]({{% ref "election-forecasting-predicting-the-winner-before-any-votes-are-cast-recitation" %}})
*   [ContinueVideo 2: Dealing with Missing Data]({{% ref "video-2-dealing-with-missing-data" %}})