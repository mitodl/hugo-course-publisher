...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-7-comparing-methods
    weight: 2280
---
...
*   [\\>Assignment 6]({{% ref "assignment-6" %}})

Video 7: Comparing Methods
--------------------------

*   [BackVideo 6: Detecting Tumors]({{% ref "video-6-detecting-tumors" %}})
*   [ContinueAssignment 6]({{% ref "assignment-6" %}})