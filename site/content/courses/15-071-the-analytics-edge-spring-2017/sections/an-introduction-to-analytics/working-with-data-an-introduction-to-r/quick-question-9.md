...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: 49c8f31e6b0499eb8a48b542d04cf7bc
    weight: 200
...
*   [BackVideo 3: Vectors and Data Frames]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/an-introduction-to-analytics/working-with-data-an-introduction-to-r/video-3-vectors-and-data-frames" %}})
*   [ContinueVideo 4: Loading Data Files]({{% getpage "courses/15-071-the-analytics-edge-spring-2017/sections/an-introduction-to-analytics/working-with-data-an-introduction-to-r/video-4-loading-data-files/_index.md" %}})