...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: 3697235ab9798298ffc243742c5e644d_video-6-this-class
    weight: 130
---
...
*   [BackVideo 5: Example 4 - D2Hawkeye]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/an-introduction-to-analytics/the-analytics-edge-intelligence-happiness-and-health-lecture-sequence/video-5-example-4-d2hawkeye" %}})
*   [ContinueWorking with Data: An Introduction to R]({{% ref "courses/15-071-the-analytics-edge-spring-2017/sections/an-introduction-to-analytics/working-with-data-an-introduction-to-r" %}})