...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-3-data-analysis
    weight: 310
---
...
*   [\\>Video 4: Creating Plots in R]({{% ref "video-4-creating-plots-in-r" %}})

Video 3: Data Analysis
----------------------

*   [BackVideo 2: Working with Data in R]({{% ref "video-2-working-with-data-in-r" %}})
*   [ContinueVideo 4: Creating Plots in R]({{% ref "video-4-creating-plots-in-r" %}})