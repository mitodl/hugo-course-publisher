...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-2-clustering-pixels
    weight: 2220
---
...
*   [BackVideo 1: Image Segmentation]({{% ref "video-1-image-segmentation" %}})
*   [ContinueVideo 3: Hierarchical Clustering]({{% ref "video-3-hierarchical-clustering" %}})