...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-2-an-optimization-model
    weight: 3230
---
*   [<Video 1: The Problem]({{% ref "video-1-the-problem" %}})
...
*   [\\>Video 3: Solving the Problem]({{% ref "video-3-solving-the-problem-5" %}})

Video 2: An Optimization Model
------------------------------

*   [BackVideo 1: The Problem]({{% ref "video-1-the-problem" %}})
*   [ContinueVideo 3: Solving the Problem]({{% ref "video-3-solving-the-problem-5" %}})