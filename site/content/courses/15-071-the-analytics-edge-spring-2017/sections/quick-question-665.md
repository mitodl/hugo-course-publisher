...
*   [BackSports Scheduling: An Introduction to Integer Optimization]({{% ref "sports-scheduling-an-introduction-to-integer-optimization" %}})
*   [ContinueVideo 2: The Optimization Problem]({{% ref "video-2-the-optimization-problem" %}})