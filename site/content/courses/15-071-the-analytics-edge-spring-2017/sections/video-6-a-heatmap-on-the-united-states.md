...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-6-a-heatmap-on-the-united-states
    weight: 2520
---
*   [<Quick Question]({{% ref "quick-question-567" %}})
...
*   [\\>Quick Question]({{% ref "quick-question-575" %}})
...
*   [BackQuick Question]({{% ref "quick-question-567" %}})
*   [ContinueQuick Question]({{% ref "quick-question-575" %}})