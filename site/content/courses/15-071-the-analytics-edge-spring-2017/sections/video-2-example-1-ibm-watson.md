...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-2-example-1-ibm-watson
    weight: 90
---
...
*   [\\>Video 3: Example 2 - eHarmony]({{% ref "video-3-example-2-eharmony" %}})

Video 2: Example 1 - IBM Watson
-------------------------------

*   [BackThe Analytics Edge: Intelligence, Happiness, and Health (Lecture Sequence)]({{% ref "the-analytics-edge-intelligence-happiness-and-health-lecture-sequence" %}})
*   [ContinueVideo 3: Example 2 - eHarmony]({{% ref "video-3-example-2-eharmony" %}})