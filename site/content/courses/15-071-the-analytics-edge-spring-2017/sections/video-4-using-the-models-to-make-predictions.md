...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-4-using-the-models-to-make-predictions
    weight: 620
---
*   [<Quick Question]({{< ref "quick-question-109" >}})
...
*   [\\>Quick Question]({{< ref "quick-question-119" >}})

Video 4: Using the Models to Make Predictions
---------------------------------------------

*   [BackQuick Question]({{< ref "quick-question-109" >}})
*   [ContinueQuick Question]({{< ref "quick-question-119" >}})