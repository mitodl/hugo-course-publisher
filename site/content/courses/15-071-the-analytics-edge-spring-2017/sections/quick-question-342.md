...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: quick-question-342
    weight: 1380
---
*   [<Video 6: Claims Data in R]({{< ref "video-6-claims-data-in-r" >}})
...
*   [BackVideo 6: Claims Data in R]({{< ref "video-6-claims-data-in-r" >}})
*   [ContinueVideo 7: Baseline Method and Penalty Matrix]({{< ref "video-7-baseline-method-and-penalty-matrix" >}})