...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-5-thresholding
    weight: 860
---
...
*   [\\>Quick Question]({{% ref "quick-question-188" %}})

Video 5: Thresholding
---------------------

*   [BackQuick Question]({{% ref "quick-question-167" %}})
*   [ContinueQuick Question]({{% ref "quick-question-188" %}})