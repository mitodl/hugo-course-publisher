...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-8-predicting-healthcare-cost-in-r
    weight: 1410
---
*   [<Quick Question]({{% ref "quick-question-349" %}})
...
*   [BackQuick Question]({{% ref "quick-question-349" %}})
*   [ContinueQuick Question]({{% ref "quick-question-357" %}})