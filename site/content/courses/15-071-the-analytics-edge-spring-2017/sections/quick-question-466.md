...
*   [BackVideo 6: Getting the Data]({{< ref "video-6-getting-the-data" >}})
*   [ContinueVideo 7: Hierarchical Clustering in R]({{< ref "video-7-hierarchical-clustering-in-r" >}})