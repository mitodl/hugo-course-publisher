...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-2-playoffs-and-wins
    weight: 700
---
...
*   [\\>Video 3: Points Scored]({{% ref "video-3-points-scored" %}})

Video 2: Playoffs and Wins
--------------------------

*   [BackVideo 1: The Data]({{% ref "video-1-the-data" %}})
*   [ContinueVideo 3: Points Scored]({{% ref "video-3-points-scored" %}})