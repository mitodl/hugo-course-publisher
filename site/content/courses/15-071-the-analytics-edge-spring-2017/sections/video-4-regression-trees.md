...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-4-regression-trees
    weight: 1480
---
...
*   [\\>Video 5: Putting it all Together]({{< ref "video-5-putting-it-all-together" >}})
...
*   [BackVideo 3: Geographical Predictions]({{< ref "video-3-geographical-predictions" >}})
*   [ContinueVideo 5: Putting it all Together]({{< ref "video-5-putting-it-all-together" >}})