...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-3-the-variables
    weight: 1310
---
*   [<Quick Question]({{% ref "quick-question-316" %}})
...
*   [BackQuick Question]({{% ref "quick-question-316" %}})
*   [ContinueQuick Question]({{% ref "quick-question-321" %}})