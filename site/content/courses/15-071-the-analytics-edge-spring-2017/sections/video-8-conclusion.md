...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-8-conclusion
    weight: 1700
---
*   [<Quick Question]({{% ref "quick-question-395" %}})
...
*   [\\>Man vs. Machine: How IBM Built a Jeopardy Champion]({{% ref "man-vs-machine-how-ibm-built-a-jeopardy-champion" %}})

Video 8: Conclusion
-------------------

*   [BackQuick Question]({{% ref "quick-question-395" %}})
*   [ContinueMan vs. Machine: How IBM Built a Jeopardy Champion]({{% ref "man-vs-machine-how-ibm-built-a-jeopardy-champion" %}})