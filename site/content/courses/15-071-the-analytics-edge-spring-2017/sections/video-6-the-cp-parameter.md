...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-6-the-cp-parameter
    weight: 1500
---
...
*   [BackVideo 5: Putting it all Together]({{< ref "video-5-putting-it-all-together" >}})
*   [ContinueVideo 7: Cross-Validation]({{< ref "video-7-cross-validation" >}})