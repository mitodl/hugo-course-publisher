...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: quick-question-54
    weight: 440
---
*   [<Video 2: One-Variable Linear Regression]({{% ref "video-2-one-variable-linear-regression" %}})
...
*   [BackVideo 2: One-Variable Linear Regression]({{% ref "video-2-one-variable-linear-regression" %}})
*   [ContinueVideo 3: Multiple Linear Regression]({{% ref "video-3-multiple-linear-regression" %}})