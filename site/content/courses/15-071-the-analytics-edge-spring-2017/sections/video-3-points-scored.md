...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-3-points-scored
    weight: 710
---
...
*   [BackVideo 2: Playoffs and Wins]({{% ref "video-2-playoffs-and-wins" %}})
*   [ContinueVideo 4: Making Predictions]({{% ref "video-4-making-predictions" %}})