...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-5-visualizing-the-problem
    weight: 2750
---
...
*   [\\>Quick Question]({{% ref "quick-question-606" %}})

Video 5: Visualizing the Problem
--------------------------------

*   [BackQuick Question]({{% ref "quick-question-598" %}})
*   [ContinueQuick Question]({{% ref "quick-question-606" %}})