...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-3-creating-the-dataset
    weight: 1600
---
...
*   [\\>Quick Question]({{% ref "quick-question-367" %}})

Video 3: Creating the Dataset
-----------------------------

*   [BackQuick Question]({{% ref "quick-question-362" %}})
*   [ContinueQuick Question]({{% ref "quick-question-367" %}})