...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-8-extensions-and-the-edge
    weight: 3010
---
...
*   [\\>Assignment 8]({{% ref "assignment-8" %}})

Video 8: Extensions and the Edge
--------------------------------

*   [BackVideo 7: Sensitivity Analysis]({{% ref "video-7-sensitivity-analysis" %}})
*   [ContinueAssignment 8]({{% ref "assignment-8" %}})