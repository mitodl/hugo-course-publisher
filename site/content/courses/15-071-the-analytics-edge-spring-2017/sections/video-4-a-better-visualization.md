...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-4-a-better-visualization
    weight: 2590
---
*   [<Video 3: Bar Charts in R]({{% ref "video-3-bar-charts-in-r" %}})
...
*   [\\>Video 5: World Maps in R]({{% ref "video-5-world-maps-in-r" %}})

Video 4: A Better Visualization
-------------------------------

*   [BackVideo 3: Bar Charts in R]({{% ref "video-3-bar-charts-in-r" %}})
*   [ContinueVideo 5: World Maps in R]({{% ref "video-5-world-maps-in-r" %}})