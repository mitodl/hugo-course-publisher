...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-7-predicting-sentiment
    weight: 1680
---
*   [<Quick Question]({{% ref "quick-question-390" %}})
...
*   [BackQuick Question]({{% ref "quick-question-390" %}})
*   [ContinueQuick Question]({{% ref "quick-question-395" %}})