...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-5-the-edge
    weight: 3130
---
*   [<Quick Question]({{% ref "quick-question-693" %}})
...
*   [BackQuick Question]({{% ref "quick-question-693" %}})
*   [ContinueeHarmony: Maximizing the Probability of Love]({{% ref "eharmony-maximizing-the-probability-of-love" %}})