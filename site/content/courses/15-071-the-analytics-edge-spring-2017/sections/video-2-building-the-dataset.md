...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-2-building-the-dataset
    weight: 800
---
...
*   [\\>Quick Question]({{% ref "quick-question-144" %}})

Video 2: Building the Dataset
-----------------------------

*   [BackModeling the Expert: An Introduction to Logistic Regression]({{% ref "modeling-the-expert-an-introduction-to-logistic-regression" %}})
*   [ContinueQuick Question]({{% ref "quick-question-144" %}})