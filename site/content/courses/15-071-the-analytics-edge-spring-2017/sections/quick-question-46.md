...
*   [BackThe Statistical Sommelier: An Introduction to Linear Regression]({{< ref "the-statistical-sommelier-an-introduction-to-linear-regression" >}})
*   [ContinueVideo 2: One-Variable Linear Regression]({{< ref "video-2-one-variable-linear-regression" >}})