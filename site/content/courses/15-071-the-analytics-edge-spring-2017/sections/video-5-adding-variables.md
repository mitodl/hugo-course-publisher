...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: video-5-adding-variables
    weight: 330
---
...
*   [BackVideo 4: Creating Plots in R]({{% ref "video-4-creating-plots-in-r" %}})
*   [ContinueVideo 6: Summary Tables]({{% ref "video-6-summary-tables" %}})