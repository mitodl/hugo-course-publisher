...
menu:
  15-071-the-analytics-edge-spring-2017:
    identifier: seeing-the-big-picture-segmenting-images-to-create-data-recitation
    weight: 2200
---
...
*   [\\>Video 1: Image Segmentation]({{% ref "video-1-image-segmentation" %}})

Welcome to Recitation 6
-----------------------

*   [BackVideo 5: The Analytics Edge]({{% ref "video-5-the-analytics-edge" %}})
*   [ContinueVideo 1: Image Segmentation]({{% ref "video-1-image-segmentation" %}})