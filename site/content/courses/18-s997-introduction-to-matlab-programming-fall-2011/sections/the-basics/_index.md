...
*   [Lecture 1: Using MATLAB for the First Time](./resolveuid/43dd1e031b2e412267e44b5e6d9d7a1f)
*   [Lecture 2: The Command Prompt](./resolveuid/9b4a2cc9714d7cf675be79f825505e30)  
    This video includes material supplementary to [Command Prompt and Expressions]({{% getpage "courses/18-s997-introduction-to-matlab-programming-fall-2011/sections/the-basics/command-prompt-and-expressions" %}}).