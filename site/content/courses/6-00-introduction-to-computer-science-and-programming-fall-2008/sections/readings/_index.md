...
[![Buy at MIT Press](/images/mp_logo.gif)](https://mitpress.mit.edu/9780262519632) [![Buy at Amazon](/images/a_logo_17.gif)](http://www.amazon.com/exec/obidos/ASIN/0262519631/ref=nosim/mitopencourse-20) Guttag, John. _Introduction to Computation and Programming Using Python_. MIT Press, 2013. ISBN: 9780262519632.
...
*   As a reference: the _Python Tutorial_ section on [lists and dictionaries](http://docs.python.org/tut/node7.html) (feel free to skip 5.1.3 and 5.1.4)

Lectures 7-8
------------

*   Asymptotic notation: Section 3 from the Spring 2005 6.042 lecture notes on OCW ([PDF]({{% getpage "courses/6-00-introduction-to-computer-science-and-programming-fall-2008/sections/readings/l11_sums2" %}}))
