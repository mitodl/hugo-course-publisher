...
| 2 | Models of computation, Python cost model, document distance | 1, 3, [Python Cost Model]({{% getpage "courses/6-006-introduction-to-algorithms-fall-2011/sections/readings/python-cost-model" %}}) |
...
| 5 | Binary search trees, BST sort | 10.4, 12.1–12.3, [Binary Search Trees]({{% getpage "courses/6-006-introduction-to-algorithms-fall-2011/sections/readings/binary-search-trees" %}}) |
