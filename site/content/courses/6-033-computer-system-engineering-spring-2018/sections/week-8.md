...
*   [Detailed Outline]({{% ref "lecture-14-outline" %}})

### Lecture Slides

*   [Lecture 14 Slides: Fault Tolerance: Reliability via Replication (PDF)](https://open-learning-course-data.s3.amazonaws.com/6-033-computer-system-engineering-spring-2018/8eb16d3628bbd77ee7e8471b9871ec09_MIT6_033S18lec14.pdf)
...
*   [Distributed Storage Assignment]({{% ref "distributed-storage-assignment" %}})
...
*   [Detailed Outline]({{% ref "lecture-15-outline" %}})

### Lecture Slides

*   [Lecture 15 Slides: Fault Tolerance: Introduction to Transactions (PDF)](https://open-learning-course-data.s3.amazonaws.com/6-033-computer-system-engineering-spring-2018/df1526408e3ec6f7e43aadfa1ce5f944_MIT6_033S18lec15.pdf)
...
*   Assigned: [Design Project Presentation (PDF)](https://open-learning-course-data.s3.amazonaws.com/6-033-computer-system-engineering-spring-2018/5b33bd84f663106474a0aa71928bbcce_MIT6_033S18dp_pres.pdf), [Design Project Presentation Evaluation Ideas (PDF)](https://open-learning-course-data.s3.amazonaws.com/6-033-computer-system-engineering-spring-2018/8c1339227ec3a880031c26d2ae95dca5_MIT6_033S18dp_eval.pdf)