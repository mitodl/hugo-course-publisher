...
{{< anchor "Lecture_3:_Engineering_as_a_rebuild" >}}Lecture 3: Engineering as a Rebuild
---------------------------------------------------------------------------------------
...
{{< anchor "Studio_2:_Broader_project_landscapes" >}}Studio 2: Broader Project Landscapes
-----------------------------------------------------------------------------------------
...
{{< anchor "Lecture_4:_Decide_what's_worth_doing" >}}Lecture 4: Decide What's Worth Doing
-----------------------------------------------------------------------------------------
