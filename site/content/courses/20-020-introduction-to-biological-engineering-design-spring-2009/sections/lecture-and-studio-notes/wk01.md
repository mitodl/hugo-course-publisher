...
---
{{< anchor "Top" >}}[Lecture and Studio Notes index]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/_index.md" %}}) | [Next week >]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/wk02" %}})
...
{{< anchor "Lecture_1:_Design,_Build,_Test" >}}Lecture 1: Design, Build, Test
-----------------------------------------------------------------------------
...
{{< anchor "Studio_1:_Sampling_of_past_projects" >}}Studio 1: Sampling of Past Projects
---------------------------------------------------------------------------------------
...
{{< anchor "Lecture_2:_Science_as_a_take-apart" >}}Lecture 2: Science as a Take-apart
-------------------------------------------------------------------------------------
