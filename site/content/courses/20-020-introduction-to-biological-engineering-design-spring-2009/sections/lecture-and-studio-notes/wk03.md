...
*   Infectious diseases: "Catch me if U can" ([PDF - 4.1MB]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/undefined" %}}))
*   Growing organs, meat, crops: "Growing, growing, grown" ([PDF]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/undefined" %}}))
*   Biofuels: "Powering up" ([PDF]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/undefined" %}}))
*   Neurology: "Bettering the human condition" ([PDF - 4.8MB]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/undefined" %}}))
*   Chronic disease: "Come out swinging" ([PDF]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/undefined" %}}))
*   Waste problems: "Trash talkin'" ([PDF]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/undefined" %}}))
...
Some framing information about counting and clocks in biology ([PDF]({{% getpage "courses/20-020-introduction-to-biological-engineering-design-spring-2009/sections/lecture-and-studio-notes/undefined" %}}))
